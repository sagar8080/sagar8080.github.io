...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const keywordData = {
		...
		"Data Product": {
			"Intelligent Data Express": "A self service data management platform. Click on it to know more!",
			"Data Observability Framework": "An enterprise data observability platform. Click on it to know more!"
		},
        "Framework": {
        ...
        "Big Data Tool": {
			"Airbyte": "Data Ingestion Framwork",
			...
			"Athena": "Interactive query service that simplifies data analysis in Amazon S3 using standard SQL",
