...
That&apos;s the distinction, and it&apos;s the one I find myself coming back to most often when building anything in the AI era. The interesting product surfaces are the ones that capture provenance as a side effect of the work actually happening, rather than the ones that ask users to assert it after the fact.
