...
const data: CaseStudyData = {
  ...
  oneLine:
    'A coordination layer for engineering teams whose work is now half-AI, with shared context, visible verification, and review patterns that survive the velocity.',
  ...
  decisions: [
    {
      ...
      why:
        'AI-assisted engineering generates a lot of plausible-looking work. Teams need to distinguish actual proof from plausible claims at a glance, without re-running everything themselves. Visibility of verification is the load-bearing UX bet.',
    },
    {
