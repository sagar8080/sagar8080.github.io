          ...
          <div className="relative grid gap-8 lg:grid-cols-[1.1fr_1fr] lg:items-start lg:gap-10">
            <div>
              ...
              <div className="mt-7">
                <Link
                  href="/pulseql"
                  className="inline-flex items-center gap-2 rounded-sm border border-vint-pink/40 bg-vint-pink/8 px-4 py-2 font-mono text-[11px] uppercase tracking-[0.18em] text-vint-cream transition-colors hover:border-vint-pink/70 hover:bg-vint-pink/15"
                >
                  explore PulseQL
