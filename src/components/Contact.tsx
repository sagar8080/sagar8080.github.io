    ...
    >
      <div className="max-w-7xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h3 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-gray-900 via-blue-600 to-purple-600 dark:from-white dark:via-blue-100 dark:to-purple-200 bg-clip-text text-transparent">
        ...
        >
          {contactLinks.map((link, index) => (
            <motion.a
              ...
              className="flex items-center gap-3 px-6 py-4 rounded-xl transition-all duration-300 bg-gray-100/10 dark:bg-gray-900/30 backdrop-blur-sm border border-gray-200/20 dark:border-gray-700/20 text-gray-700 dark:text-gray-300 hover:bg-blue-500/10 dark:hover:bg-blue-500/20 hover:border-blue-400/50"
        ...
        <motion.div
          className="text-sm md:text-base justify-center text-center text-gray-600 dark:text-gray-400 mb-10 py-4"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
